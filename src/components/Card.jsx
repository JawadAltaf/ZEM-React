        ...
        <>
            <div className="sm:m-2 lg:mt-8 px-5 lg:flex lg:gap-5 xl:gap-[30px] cards_Section">
                <div className="rounded-2xl bg-[#dbece5] p-[30px] md:py-[53px] md:px-[48px] relative mb-5 flex flex-col justify-between transition-all duration-300 bg-bg-5 hover:translate-y-[-2px]">
                    <div><img className="h-full w-full object-cover mb-[30px] max-w-[80px] max-h-[80px]" src="/src/assets/images/icons/icon-flower.svg" alt="icon" />
                    ...
                    <img className="absolute bottom-0 right-0 z-0 max-w-[90px] md:max-w-[144px] max-h-[90px] md:max-h-[144px] translate-x-[20%] translate-y-[20%] xl:translate-x-0 xl:translate-y-0" src="/src/assets/images/icons/icon-flower-white.svg" alt="icon" />
                </div>
                <div className="rounded-2xl bg-[#d1ecfd]  p-[30px] md:py-[53px] md:px-[48px] relative mb-5 flex flex-col justify-between transition-all duration-300 bg-bg-9 hover:translate-y-[-2px]">
                    <div><img className="h-full w-full object-cover mb-[30px] max-w-[80px] max-h-[80px]" src="/src/assets/images/icons/icon-map.svg" alt="icon" />
                    ...
                    <img className="absolute bottom-0 right-0 z-0 max-w-[90px] md:max-w-[144px] max-h-[90px] md:max-h-[144px] translate-x-[20%] translate-y-[20%] xl:translate-x-0 xl:translate-y-0" src="/src/assets/images/icons/icon-map-white.svg" alt="icon" />
                </div>
                <div className="rounded-2xl bg-[#fff3ea] p-[30px] md:py-[53px] md:px-[48px] relative mb-5 flex flex-col justify-between transition-all duration-300 bg-bg-2 hover:translate-y-[-2px]">
                    <div><img className="h-full w-full object-cover mb-[30px] max-w-[80px] max-h-[80px]" src="/src/assets/images/icons/icon-pine.svg" alt="icon" />
                    ...
                    <img className="absolute bottom-0 right-0 z-0 max-w-[90px] md:max-w-[144px] max-h-[90px] md:max-h-[144px] translate-x-[20%] translate-y-[20%] xl:translate-x-0 xl:translate-y-0" src="/src/assets/images/icons/icon-pine-white.svg" alt="icon" />
                </div>
            </div>
        </>
    )
